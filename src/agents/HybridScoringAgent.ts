...
import { MetricsAnalyzer, type MetricsScores } from '../services/MetricsAnalyzer.js';
import type { EvaluationResult, Screenshot } from '../core/types.js';
import { ClaudeOpusVisionPlugin } from '../plugins/vision-claude.js';
