 ...
 */
const BackendServerManager_1 = require("./src/services/BackendServerManager");
async function testBackendManager() {
    ...
    const manager = new BackendServerManager_1.BackendServerManager(config, { verbose: true });
    try {
...
testBackendManager();
//# sourceMappingURL=backend-manager-test.js.map